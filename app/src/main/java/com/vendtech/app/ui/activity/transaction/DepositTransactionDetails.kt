...
class DepositTransactionDetails : Activity(){
    ...
    fun SetData(){
            ...
            vendorNameLL.visibility = View.VISIBLE
            chequeslipLL.visibility = View.VISIBLE
            commentBoxLL.visibility = View.VISIBLE
            ...
            amntTrans.text = "SSL :  ${NumberFormat.getNumberInstance(Locale.US).format(amountTrans.toDouble().toInt())}"
