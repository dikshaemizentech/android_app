...
class VerificationCodeActivity : AppCompatActivity() {
    ...
    private fun onClickListners() {
        ...
        txtSubmit.setOnClickListener(View.OnClickListener {
            ...
            if(TextUtils.isEmpty(etOne.text.toString().trim()) || TextUtils.isEmpty(etTwo.text.toString().trim()) || TextUtils.isEmpty(etThree.text.toString().trim()) || TextUtils.isEmpty(etFour.text.toString().trim()) ){
    ...
    fun SubmitOTP(code:String){
        ...
        val call: Call<VerifyOTPModel> = Uten.FetchServerData().verify_otp(code,SharedHelper.getString(this,Constants.USER_ID))
