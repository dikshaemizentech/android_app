...
import com.vendtech.app.models.authentications.SignUpResponse
...
class AddMeterActivity : Activity(), View.OnClickListener {
    ...
    fun AddMeter() {
        ...
        val call: Call<AddMeterModel> = Uten.FetchServerData().add_meter(SharedHelper.getString(this, Constants.TOKEN), meternameET.text.toString().trim(), metermakeET.text.toString().trim(), addressET.text.toString().trim(), meternoET.text.toString().trim())
